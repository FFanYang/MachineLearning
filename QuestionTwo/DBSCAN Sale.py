...
for eps in [1,0.3,0.45,0.75,1.5,0.5]:# If set parameter as 0.75, after the highest will get.
...
for i, c in enumerate(cluster_labels):
    ...
    plt.barh(range(y_ax_lower, y_ax_upper), c_silhouette_vals, height=3.0, edgecolor='none', color=color)
    yticks.append((y_ax_lower + y_ax_upper) / 2.5)
