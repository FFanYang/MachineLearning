...
print(t,sse_dowjones_db,csm_dowjones_db)


#DBSCAN ALGORITHM
db = DBSCAN(eps=0.8, min_samples=32, metric='euclidean')
y_km = db.fit_predict(dow_jones)
...
plt.tight_layout()
plt.savefig(
    '/Users/fanyang/OneDrive - AUT University/MASTER OF AUT 20 July 2020/Semester 1 Middle 1 March  2021/Data mining Machine learning/Project/AssignmentTwo/figure/piclive2C=5',
    dpi=300)
plt.show()
